...
These techniques targeted networks and systems that have not existed for decades. They don't work today, and the activities they described were mostly illegal. At the time, however, *TAP* was one of the few publications carrying very hard-to-find technical specifics and discoveries, so it circulated widely among those interested in telecommunications, computers, and solving puzzles.

Looking back, it was a strange mix. Part of it was pure curiosity, the urge to map out complex, mysterious networks and figure out how everything worked. Part of it was the growing realization that these supposedly secure systems were wide open. And a substantial portion simply provided practical advice on stealing long-distance service, electricity, gas, cable television, and other utilities, which the editors framed as a form of resistance or ‘revolution.’

The technical material was often fascinating, but the editors’ open endorsement of using techniques for theft helped reinforce the perception of all hackers as thieves, including among prosecutors.

As readership grew, interest in obtaining free services started overshadowing technical curiosity. Overuse made the exploits less and less effective and increasingly risky to experiment with. Because government agencies, utilities, and prosecutors also subscribed, techniques that appeared in print quickly became known to the very organizations they targeted.
...
This archive is presented as a historical record of how restricted technical information circulated before the public Internet.
